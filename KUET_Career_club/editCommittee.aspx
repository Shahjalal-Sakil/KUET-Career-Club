<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editCommittee.aspx.cs" Inherits="KUET_Career_club.editCommittee" ValidateRequest="false" %>
...
<body style="font-family:none;">
    ...
    <div class="contentsection templete clear">
		...
		<div class="maincontent clear" style="float:right;margin-right:0px;min-height:600px">
			...
			<div>
				<h2 class="abouth2">Update Committee</h2>
                    ...
                    <tr>
						...
						<td>
                            ...
                            <FTB:FreeTextBox ID="clubCommittee" runat="server" Width="550px" Height="200px"> </FTB:FreeTextBox>
						...
						<td></td>
						<td>
                            <asp:Button ID="updateCommitteeButton" runat="server" Text="Update" OnClick="updateCommitteeButton_Click" />
						</td>
					</tr>
				</table>
