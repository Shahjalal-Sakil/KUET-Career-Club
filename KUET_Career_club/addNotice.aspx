<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addNotice.aspx.cs" Inherits="KUET_Career_club.addNotice" ValidateRequest="false" %>
...
<body style="font-family:none;">
    ...
    <div class="contentsection templete clear">
		...
		<div class="maincontent clear" style="float:right;margin-right:0px;min-height:600px">
			...
			<div>
				<h2 class="abouth2">Post Notice</h2>
                    ...
                    <tr>
						...
						<td>
                            ...
                            <FTB:FreeTextBox ID="noticeDetails" runat="server" Width="550px" Height="200px"> </FTB:FreeTextBox>
